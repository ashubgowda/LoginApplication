...
public class Login2 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Login2.loginCredentials(driver, userName, passWord,wait);

		//Validate reset password scenario
		String resetPassword = Login2.resetPassword(driver, userName, emailID, phoneNumber);
		...
		Login2.loginCredentials(driver, userName, resetPassword, wait);

		//Validate Successful login screen
		Login2.validateSuccessfulLogin(driver, userName, wait);
	...
	public static void loginCredentials(WebDriver driver, String userName, String passWord, WebDriverWait wait) {
		...
		wait.until(ExpectedConditions.textToBePresentInElementLocated(By.xpath("//h2[contains(text(),'Forgot password')]"), "Forgot password"));
		Assert.assertEquals(driver.findElement(By.xpath("//h2[contains(text(),'Forgot password')]")).getText(),
				"Forgot password");
	}

	public static String resetPassword(WebDriver driver, String userName, String emailID, String phoneNumber) {
		driver.findElement(By.xpath("//div[@class='form-container sign-up-container']/form/input[1]")).sendKeys(userName);
	...
	public static void validateSuccessfulLogin(WebDriver driver, String userName, WebDriverWait wait) {
		wait.until(ExpectedConditions.textToBePresentInElementLocated(By.cssSelector("div[class='login-container'] h2"), userName));
